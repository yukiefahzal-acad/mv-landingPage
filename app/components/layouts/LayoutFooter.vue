         ...
         <div class="mx-auto max-w-7xl">
            ...
            <div class="grid grid-cols-1 gap-8 md:grid-cols-3">
               ...
               <div class="text-center md:text-left">
                  <h4 class="mb-3 text-sm text-gray-400">Find Us</h4>
                  <p class="mb-1 font-medium text-white">123 Clever Street</p>
                  <p class="text-gray-400">Wellness State, 12345</p>
               </div>

               <div class="text-center md:text-right">
                  <h4 class="mb-3 text-sm text-gray-400">Contact</h4>
                  <p class="mb-1 font-medium text-white">(123) 456-7890</p>
                  <a
                     href="mailto:support@clever.com"
                     class="text-gray-400 transition hover:text-emerald-500"
                  >
                     Support@clever.com
                  </a>
               </div>
